  ...
  return (
    <div className='aboutMe'>
      ...
      <p className='aboutText'>
        ...
        Berkeley Extension's Coding Bootcamp. The technical skills that I've
        gained from the coding bootcamp include HTML, Cascading Style Sheets
        (CSS), Javascript, jQuery, Node.js, Express, MySQL, Sequelize, Git,
        React, MongoDB, and REST APIs. My experiences in the coding bootcamp
